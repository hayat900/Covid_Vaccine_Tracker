...
class MainActivity3 : AppCompatActivity() {
    ...
    private lateinit var floatbut: ImageButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchButton.setOnClickListener {
            ...
            if (pinCode.length != 6) {
                ...
                Toast.makeText(this@MainActivity3, "Please enter valid pin code", Toast.LENGTH_SHORT).show()
            } else {
    ...
    private fun getAppointments(pinCode: String, date: String) {
        ...
        val queue = Volley.newRequestQueue(this@MainActivity3)
                ...
                JsonObjectRequest(Request.Method.GET, url, null, { response ->
                    ...
                    try {
                        ...
                        { error ->
                            ...
                            Toast.makeText(this@MainActivity3, "Fail to get response", Toast.LENGTH_SHORT).show()
                        })
